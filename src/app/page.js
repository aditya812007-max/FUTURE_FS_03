  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mb-6 px-4 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 backdrop-blur-md animate-fade-up">
        ...
        <p className="text-lg md:text-xl text-slate-300 max-w-2xl mb-12 leading-relaxed animate-fade-up-delay">
